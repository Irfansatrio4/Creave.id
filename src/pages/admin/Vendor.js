...
import TableVendor from "../../component/TableVendor";
            ...
            <div>
              <div>
                <div className="flex justify-between">
                  <div>
                    <p className="text-2xl uppercase font-bold pb-7">Vendor</p>
                  </div>
                  <div>
                    <button
                      class="hover:shadow-md text-gray-800 bg-yellow-500 font-bold mr-4 py-2 px-8 rounded items-center content-center"
                      onClick={() => history.push("/admin/vendor/form")}
                    >
                      <span className="text-black">Tambah Data Vendor</span>
                    </button>
                  </div>
                </div>
              </div>
